...
extern "C" {
    ...
    pub fn activation_leaky_fp16(data: *mut c_void, elements: usize, stream: cudaStream_t) -> cudaError_t;
    pub fn activation_leaky_fp32(data: *mut c_void, elements: usize, stream: cudaStream_t) -> cudaError_t;
    pub fn activation_leaky_fp64(data: *mut c_void, elements: usize, stream: cudaStream_t) -> cudaError_t;
